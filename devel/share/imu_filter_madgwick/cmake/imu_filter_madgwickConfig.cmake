...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /root/summer2019/src/imu_tools/imu_filter_madgwick)
  set(imu_filter_madgwick_DEVEL_PREFIX /root/summer2019/devel)
  ...
  set(imu_filter_madgwick_INSTALL_PREFIX /root/summer2019/install)
...
if(NOT "/root/summer2019/devel/include;/usr/include " STREQUAL " ")
  set(imu_filter_madgwick_INCLUDE_DIRS "")
  set(_include_dirs "/root/summer2019/devel/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/summer2019/src/imu_tools/imu_filter_madgwick/${idir}'.  ${_report}")
    endif()
