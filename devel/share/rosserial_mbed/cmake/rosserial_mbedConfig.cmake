...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_mbed_SOURCE_PREFIX /root/ws/src/rosserial/rosserial_mbed)
  set(rosserial_mbed_DEVEL_PREFIX /root/ws/devel)
  ...
  set(rosserial_mbed_INSTALL_PREFIX /root/ws/install)
...
if(NOT "/root/ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ws/src/rosserial/rosserial_mbed/${idir}'.  ${_report}")
    endif()
